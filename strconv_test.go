...
func TestConversionFromString(T *testing.T) {
	...
	if err != nil {
		T.Errorf("Error converting string to string; %s", err.Error())
	}
	if s != "astring" {
	...
	if err != nil {
		T.Errorf("Error converting string to bool; %s", err.Error())
	}
	if b != true {
	...
	if err != nil {
		T.Errorf("Error converting string to int8; %s", err.Error())
	}
	if i8 != int8(123) {
	...
	if err != nil {
		T.Errorf("Error converting string to int16; %s", err.Error())
	}
	if i16 != int16(123) {
	...
	if err != nil {
		T.Errorf("Error converting string to int32; %s", err.Error())
	}
	if i32 != int32(123) {
	...
	if err != nil {
		T.Errorf("Error converting string to int64; %s", err.Error())
	}
	if i64 != int64(123) {
	...
	if err != nil {
		T.Errorf("Error converting string to uint; %s", err.Error())
	}
	if ui != uint(123) {
	...
	if err != nil {
		T.Errorf("Error converting string to uint8; %s", err.Error())
	}
	if ui8 != uint8(123) {
	...
	if err != nil {
		T.Errorf("Error converting string to uint16; %s", err.Error())
	}
	if ui16 != uint16(123) {
	...
	if err != nil {
		T.Errorf("Error converting string to uint32; %s", err.Error())
	}
	if ui32 != uint32(123) {
	...
	if err != nil {
		T.Errorf("Error converting string to uint64; %s", err.Error())
	}
	if ui64 != uint64(123) {
	...
	if err != nil {
		T.Errorf("Error converting string to float32; %s", err.Error())
	}
	if f32 != float32(1.25) {
	...
	if err != nil {
		T.Errorf("Error converting string to float64; %s", err.Error())
	}
	if f64 != float64(1.25) {
